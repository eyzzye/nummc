...
#define UNIT_SPECIAL_ID_STRENGTH_DOWN        (15)
#define UNIT_SPECIAL_ID_END                  (16)
...
#define UNIT_ITEM_ID_S_STRENGTH_DOWN       (UNIT_ITEM_FLAG_SPECIAL    |   UNIT_SPECIAL_ID_STRENGTH_DOWN      )
