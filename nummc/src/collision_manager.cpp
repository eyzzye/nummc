...
// static body
#define STATIC_SHAPE_LIST_SIZE ((((MAP_WIDTH_NUM_MAX*MAP_HEIGHT_NUM_MAX*MAP_TYPE_END + TILE_TEX_NUM \
                                   + UNIT_TRAP_LIST_SIZE + UNIT_TRAP_BASE_LIST_SIZE \
                                   + UNIT_EFFECT_LIST_SIZE + UNIT_EFFECT_BASE_LIST_SIZE \
                                  ) + 64) / 64) * 64)
...
// dynamic body
#define DYNAMIC_SHAPE_LIST_SIZE ((((1 + UNIT_PLAYER_BASE_LIST_SIZE + UNIT_ENEMY_LIST_SIZE + UNIT_ENEMY_BASE_LIST_SIZE \
                                      + UNIT_ITEMS_LIST_SIZE + UNIT_ITEMS_BASE_LIST_SIZE + UNIT_TRAP_LIST_SIZE + UNIT_TRAP_BASE_LIST_SIZE \
                                      + UNIT_EFFECT_LIST_SIZE + UNIT_EFFECT_BASE_LIST_SIZE \
                                      + UNIT_PLAYER_BULLET_LIST_SIZE + UNIT_PLAYER_BULLET_BASE_LIST_SIZE \
                                      + UNIT_ENEMY_BULLET_LIST_SIZE + UNIT_ENEMY_BULLET_BASE_LIST_SIZE \
                                    ) + 64) / 64) * 64)
